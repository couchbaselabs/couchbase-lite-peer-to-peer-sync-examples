...
** Download the Visual Studio from the link:https://visualstudio.microsoft.com/downloads/[Microsoft Website]
...
** Note: If you are running Android apps on emulators, please see <<Connecting to Android emulator over localhost>>
