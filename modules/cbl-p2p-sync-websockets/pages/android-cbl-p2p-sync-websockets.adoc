...
:code-examples: {source-language}:example$
:idprefix:
:idseparator: -
:icons: font
...
----
include::{code-examples}list-sync/list-sync/model/DatabaseManager.swift[tags=OpenOrCreateDatabase]
----
...
[source, {source-language}]
----
include::{code-examples}list-sync/list-sync/model/DatabaseManager.swift[tags=LoadData]
----
...
[source, {source-language}]
----
include::{code-examples}list-sync/list-sync/model/DatabaseManager.swift[tags=InitListener]
----
...
[source, {source-language}]
----
include::{code-examples}list-sync/list-sync/model/DatabaseManager.swift[tags=ListenerValidationTestMode]
----
...
[source, {source-language}]
----
include::{code-examples}list-sync/list-sync/model/DatabaseManager.swift[tags=StartListener]
----
...
[source, {source-language}]
----
include::{code-examples}list-sync/list-sync/discovery/ServiceAdvertiser.swift[tags=ServiceDefinition]
----
...
[source, {source-language}]
----
include::{code-examples}list-sync/list-sync/discovery/ServiceAdvertiser.swift[tags=StartAdvertiser]
----
...
[source, {source-language}]
----
include::{code-examples}list-sync/list-sync/model/DatabaseManager.swift[tags=StopListener]
----
...
[source, {source-language}]
----
include::{code-examples}list-sync/list-sync/discovery/ServiceBrowser.swift[tags=StartBrowsing]
----
...
[source, {source-language}]
----
include::{code-examples}list-sync/list-sync/model/DatabaseManager.swift[tags=StartReplication]
----
...
[source, {source-language}]
----
include::{code-examples}list-sync/list-sync/model/DatabaseManager.swift[tags=StopReplication]
----
