...
//image::TODO[List App with p2p Sync][alt=peer to peer sync, width=600,height=480]

== App Installation

=== Downloading .zip

- Download the .zip project from link:https://drive.google.com/file/d/1wEit_q5oEc5b0UrWzH418S0_-Sia-30p/view?usp=sharing[here]
